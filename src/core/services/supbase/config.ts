...
const shouldUseMockClient = isSelfHosted || !supabaseUrl || !supabaseKey;
const supabase = shouldUseMockClient ? (createMockClient() as any) : createClient(supabaseUrl, supabaseKey);
